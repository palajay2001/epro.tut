    ...
    <div class="leading-loose">
      ...
      <form class="max-w-xl m-4 p-10 bg-white rounded shadow-xl" action="{{ route('login')}}" method="post">
        ...
        <div class="">
          ...
          <input class="w-full px-5 py-1 text-gray-700 bg-gray-200 rounded" id="username" name="email" type="text" required="" placeholder="User Name" aria-label="username">
        </div>
        <div class="mt-2">
        ...
        <a class="inline-block right-0 align-baseline font-bold text-sm text-500 hover:text-blue-800" href="{{ Route('registerform')}}">
          Not registered ?
        </a>
      </form>
