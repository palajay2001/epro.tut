...
<html lang="en">
  ...
  <body>
    <div class="container">
        <h5 class="text-center">Student Update Form</h5>
        <form action="{{ route('Update', $data->id)}}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="class" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="{{$data->class}}">
              </div>
